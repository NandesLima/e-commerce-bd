...
!!! abstract "Objetivo"
    Projetar a arquitetura de dados para uma plataforma de E-commerce complexa, contemplando o fluxo desde o cadastro de produtos por terceiros (Marketplace) até a logística de entrega e processamento de pagamentos múltiplos.
...
---
*Este repositório demonstra proficiência em **Engenharia de Requisitos** e **Modelagem de Dados** aplicada a ecossistemas de vendas digitais, desenvolvido por **Ariel Shlomoh**.*